...
public class ParallelLogic {
    ...
    public static int limitParallelByItems(Recipe recipe, OverlayedItemHandler overlayedItemHandler, int multiplier) {
        ...
        // Simulate Parallel outputs for the case of receiving all chanced outputs, to ensure space for everything
        HashMap<ItemStackKey, Integer> recipeOutputs = GTHashMaps.fromItemStackCollection(recipe.getAllItemOutputs());
    ...
    public static int limitParallelByFluids(Recipe recipe, OverlayedFluidHandler overlayedFluidHandler, int multiplier) {
        ...
        //TODO, chanced Fluid Outputs here in the future
