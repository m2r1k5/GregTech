...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Europium = new Material.Builder(33, "europium")
                .ingot().fluid()
                .iconSet(METALLIC)
                .flags(STD_METAL, GENERATE_LONG_ROD, GENERATE_FINE_WIRE, GENERATE_SPRING_SMALL, GENERATE_RING)
                .element(Elements.Eu)
        ...
        Iridium = new Material.Builder(50, "iridium")
                .ingot(3).fluid().ore()
                .color(0xF0F0F5)
                .flags(EXT2_METAL, GENERATE_ROTOR, GENERATE_DENSE, GENERATE_FRAME)
                .element(Elements.Ir)
        ...
        Tungsten = new Material.Builder(115, "tungsten")
                ...
                .flags(EXT2_METAL, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_RING, GENERATE_FRAME)
                .element(Elements.W)
                .toolStats(7.0f, 3.0f, 2560, 21)
        ...
        Naquadah = new Material.Builder(124, "naquadah")
                .ingot(4).fluid().ore()
                .color(0x323232).iconSet(METALLIC)
                .flags(EXT_METAL, GENERATE_FOIL, GENERATE_SPRING, GENERATE_FINE_WIRE, GENERATE_RING)
                .element(Elements.Nq)
        ...
        Trinium = new Material.Builder(130, "trinium")
                ...
                .flags(GENERATE_FOIL, GENERATE_ROTOR)
                .element(Elements.Ke)
                .blastTemp(8600)
                .build();
