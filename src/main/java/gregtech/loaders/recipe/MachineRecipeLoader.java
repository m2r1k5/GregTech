...
//            .duration(72000).EUt(480).buildAndRegister();
    ...
    private static void registerBlastFurnaceRecipes() {
        BLAST_RECIPES.recipeBuilder().duration((int) Math.max(TungstenSteel.getMass() / 80, 1) * TungstenSteel.getBlastTemperature()).EUt(480).input(ingot, Tungsten).input(ingot, Steel).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.TungstenSteel, 2), OreDictUnifier.get(OrePrefix.dustSmall, Materials.DarkAsh)).blastFurnaceTemp(TungstenSteel.getBlastTemperature()).buildAndRegister();
        BLAST_RECIPES.recipeBuilder().duration((int) Math.max(TungstenCarbide.getMass() / 40, 1) * TungstenCarbide.getBlastTemperature()).EUt(480).input(ingot, Tungsten).input(dust, Carbon).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.TungstenCarbide, 2), OreDictUnifier.get(OrePrefix.dustSmall, Materials.DarkAsh)).blastFurnaceTemp(TungstenCarbide.getBlastTemperature()).buildAndRegister();
        BLAST_RECIPES.recipeBuilder().duration((int) Math.max(VanadiumGallium.getMass() / 40, 1) * VanadiumGallium.getBlastTemperature()).EUt(480).input(ingot, Vanadium, 3).input(ingot, Gallium).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.VanadiumGallium, 4), OreDictUnifier.get(OrePrefix.dustSmall, Materials.DarkAsh, 2)).blastFurnaceTemp(VanadiumGallium.getBlastTemperature()).buildAndRegister();
        BLAST_RECIPES.recipeBuilder().duration((int) Math.max(NiobiumTitanium.getMass() / 80, 1) * NiobiumTitanium.getBlastTemperature()).EUt(480).input(ingot, Niobium).input(ingot, Titanium).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.NiobiumTitanium, 2), OreDictUnifier.get(OrePrefix.dustSmall, Materials.DarkAsh)).blastFurnaceTemp(NiobiumTitanium.getBlastTemperature()).buildAndRegister();
        BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Nichrome.getMass() / 32, 1) * Nichrome.getBlastTemperature()).EUt(480).input(ingot, Nickel, 4).input(ingot, Chrome).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.Nichrome, 5), OreDictUnifier.get(OrePrefix.dustSmall, Materials.DarkAsh, 2)).blastFurnaceTemp(Nichrome.getBlastTemperature()).buildAndRegister();
